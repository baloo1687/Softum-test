...
/* harmony export */ });
/* harmony import */ var _generateCardMarkup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./generateCardMarkup */ "./src/js/components/generateCardMarkup.js");
...
const addCard = () => {
  ...
  (0,_generateCardMarkup__WEBPACK_IMPORTED_MODULE_0__.generateCardMarkup)();
};

/***/ }),

/***/ "./src/js/components/clearCardList.js":
/*!********************************************!*\
  !*** ./src/js/components/clearCardList.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "clearCardList": () => (/* binding */ clearCardList)
/* harmony export */ });
/* harmony import */ var _fillCardList__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fillCardList */ "./src/js/components/fillCardList.js");
/* harmony import */ var _generateCardMarkup__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./generateCardMarkup */ "./src/js/components/generateCardMarkup.js");
...
const clearCardList = () => {
  ...
  cardNodes.forEach((e, i) => {
    if (i !== 0) {
      (0,_generateCardMarkup__WEBPACK_IMPORTED_MODULE_1__.removeCardData)(e);
      e.remove();
    }
  });
...
/***/ "./src/js/components/controler.js":
/*!****************************************!*\
  !*** ./src/js/components/controler.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _clearCardList__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./clearCardList */ "./src/js/components/clearCardList.js");
/* harmony import */ var _fillCardList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./fillCardList */ "./src/js/components/fillCardList.js");
/* harmony import */ var _modal__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modal */ "./src/js/components/modal.js");
/* harmony import */ var _removeCard__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./removeCard */ "./src/js/components/removeCard.js");
...
const controler = () => {
  ...
  nodes.control.addEventListener('click', e => {
    if (e.target.classList.contains('js-control-add')) {
      (0,_addCard__WEBPACK_IMPORTED_MODULE_0__.addCard)();
    }

    if (e.target.classList.contains('js-control-remove')) {
      (0,_removeCard__WEBPACK_IMPORTED_MODULE_4__.removeCard)();
    }

    if (e.target.classList.contains('js-control-clear')) {
      (0,_clearCardList__WEBPACK_IMPORTED_MODULE_1__.clearCardList)();
    }

    if (e.target.classList.contains('js-control-fill')) {
      (0,_fillCardList__WEBPACK_IMPORTED_MODULE_2__.fillCardList)();
      window.addEventListener('scroll', _fillCardList__WEBPACK_IMPORTED_MODULE_2__.addCardWhileScroll);
    }
  });
  nodes.cards.addEventListener('click', e => {
    if (e.target.classList.contains('js-card-open')) {
      (0,_modal__WEBPACK_IMPORTED_MODULE_3__.modal)(e.target);
      (0,_modal__WEBPACK_IMPORTED_MODULE_3__.modalShow)();
    }

    if (e.target.classList.contains('js-card-remove')) {
      (0,_removeCard__WEBPACK_IMPORTED_MODULE_4__.removeCard)(e.target.closest('.js-card'));
    }
  });
  nodes.modal.addEventListener('click', e => {
    if (e.target.classList.contains('js-modal-overlay')) {
      (0,_modal__WEBPACK_IMPORTED_MODULE_3__.modalHide)();
    }
  });
};
...
/***/ "./src/js/components/fillCardList.js":
/*!*******************************************!*\
  !*** ./src/js/components/fillCardList.js ***!
  \*******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "addCardWhileScroll": () => (/* binding */ addCardWhileScroll),
/* harmony export */   "fillCardList": () => (/* binding */ fillCardList)
/* harmony export */ });
/* harmony import */ var _generateCardMarkup__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./generateCardMarkup */ "./src/js/components/generateCardMarkup.js");
...
const addCardWhileScroll = () => {
  let cardNodes = document.querySelectorAll('.js-card');

  if ((0,_isInViewPort__WEBPACK_IMPORTED_MODULE_1__.isInViewPort)(cardNodes[cardNodes.length - 1])) {
    let cardSize = getCardSize();
    fillColumn(cardSize);
  }
};
...
/***/ "./src/js/components/generateCardMarkup.js":
/*!*************************************************!*\
  !*** ./src/js/components/generateCardMarkup.js ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "generateCardMarkup": () => (/* binding */ generateCardMarkup),
...
const cardsData = [];
const generateCardMarkup = (cb, storageData) => {
  ...
  setTimeout(() => {
    const title = (0,_generateString__WEBPACK_IMPORTED_MODULE_0__.generateString)(15);
    const text = (0,_generateString__WEBPACK_IMPORTED_MODULE_0__.generateString)(50);
    const modalContent = (0,_generateString__WEBPACK_IMPORTED_MODULE_0__.generateString)(300);
    cardNode.innerHTML = "\n            <h2 class=\"cards__item-title\">".concat(title, "</h2>\n            <p class=\"cards__item-text\">").concat(text, "</p>\n            <button class=\"button button--default js-card-open\">Open modal</button>\n            <button class=\"button button--purple js-card-remove\">Remove card</button>\n        ");
    setCardData(cardNode, modalContent);
    if (cb) cb();
  }, 3000);
};
const setCardData = (node, modalContent) => {
  cardsData.push({
    'node': node,
...
const modal = buttonNode => {
  const modalContentNode = document.querySelector('.js-modal-content');
  const cardData = (0,_generateCardMarkup__WEBPACK_IMPORTED_MODULE_0__.getCardData)(buttonNode);
...
const removeCard = node => {
  ...
  if (node) {
    node.remove();
    (0,_generateCardMarkup__WEBPACK_IMPORTED_MODULE_0__.removeCardData)(node);
  } else {
    cardNodes[cardNodes.length - 1].remove();
    (0,_generateCardMarkup__WEBPACK_IMPORTED_MODULE_0__.removeCardData)(cardNodes[cardNodes.length - 1]);
  }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_controler__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/controler */ "./src/js/components/controler.js");

(0,_components_controler__WEBPACK_IMPORTED_MODULE_0__.controler)();
